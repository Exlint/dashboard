	...
	overrides: [
		{
			files: [
				'./src/icons.ts',
				'./src/i18n/en.ts',
				'./src/components/containers/Main/LibrariesBox/LintersOutput/*',
			],
			rules: {
				'max-lines': 'off',
			},
		...
		{
			files: [
				'./src/components/containers/Main/LibrariesBox/LintersOutput/LintersOutput.view.tsx',
				'./src/components/containers/Main/LibrariesBox/AnimationBox/CardCarousel/CardCarousel.jsx',
			],
			rules: {
