...
const PoliciesView: React.FC<IProps> = (props: React.PropsWithChildren<IProps>) => {
	...
	const tableColumns = [
		t('groupCenter.policies.table.columns.label'),
		t('groupCenter.policies.table.columns.library'),
		t('groupCenter.policies.table.columns.language'),
	];
	...
	return (
		<div className={classes['container']}>
			<EDTable
				...
				header={t('groupCenter.policies.table.header')}
				buttonText={t('groupCenter.policies.table.newButton')}
			...
			<div className={classes['descriptionContainer']}>
				<div className={classes['descriptionHeader']}>
					<h4 className={classes['descriptionHeader__text']}>
						{t('groupCenter.policies.aboutHeader')}
					</h4>
					<EDSvg
