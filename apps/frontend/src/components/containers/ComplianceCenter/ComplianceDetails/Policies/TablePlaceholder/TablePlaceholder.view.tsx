	...
	return (
		<div className={classes['container']}>
			<h3 className={classes['container__header']}>
				{t('complianceCenter.policies.table.placeholderHeader')}
			</h3>
			...
			<div className={classes['illustrationsContainer']}>
				<div className={classes['contentContainer']}>
					<img
						...
						alt={t('complianceCenter.policies.table.createPolicyLeft')}
					/>
					<span className={classes['contentContainer__text']}>
						{t('complianceCenter.policies.table.createPolicyLeft')}
					</span>
				</div>
				...
				<div className={classes['contentContainer']}>
					<img
						...
						alt={t('complianceCenter.policies.table.createPolicyRight')}
					/>
					<span className={classes['contentContainer__text']}>
						<Trans i18nKey="complianceCenter.policies.table.createPolicyRight" />
					</span>
				</div>
			</div>
		</div>
